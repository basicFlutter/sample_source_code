...
class OntarioDriversLicense extends DriversLicenseRepository{
  ...
  RegExp dateRegex =  RegExp(r"\s?(\d\s?){4}\s?/\s?(\d\s?){2}\s?/\s?(\d\s?){2}\s?|\d{4}-\w{3,4}-\d{2}" , caseSensitive: false);
  RegExp licenseNumberRegex = RegExp(r"((\w\s?){0,2}\s?(\d\s?){3,4}\s?)-\s?([\dobszig]\s?){5}\s?-\s?([\dobszig]\s?){5}" ,caseSensitive: false);
  ...
  String? fixDate(String date) {
    ...
    monthFix = monthFix?.replaceAll(RegExp(r"g" ,caseSensitive: false), "9");
    monthFix = monthFix?.replaceAll(RegExp(r"b" ,caseSensitive: false), "8");
    monthFix = monthFix?.replaceAll(RegExp(r"o" ,caseSensitive: false), "0");
    monthFix = monthFix?.replaceAll(RegExp(r"z" ,caseSensitive: false), "2");
    monthFix = monthFix?.replaceAll(RegExp(r"s" ,caseSensitive: false), "5");
    monthFix = monthFix?.replaceAll(RegExp(r"t" ,caseSensitive: false), "1");
    monthFix = monthFix?.replaceAll(RegExp(r"d" ,caseSensitive: false), "0");
