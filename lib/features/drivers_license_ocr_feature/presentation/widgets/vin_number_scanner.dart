...
class VinNumberScanner extends StatefulWidget {
  const VinNumberScanner({Key? key }) : super(key: key);


  @override
  State<VinNumberScanner> createState() => _VinNumberScannerState();
}

class _VinNumberScannerState extends State<VinNumberScanner>  with WidgetsBindingObserver {
              ...
              body: BlocConsumer<CameraBloc, CameraState>(
                ...
                builder: (context, state) {
                  ...
                  if(state.cameraStatus is CameraInitCompleted){
                    ...
                    double cornerRadius = 0.064;
                    double rectangleOverLayHeight = rectangleOverLayWidth / ratio*0.5;
                              ...
                              child: IntrinsicHeight(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    CustomText(text: "Scanning Vin Number",
                                    ...
                                    Flexible(
                                      child:
                                      CustomText(text: "Position your Vin Number Within the Rectangle and Ensure the Image is Perfectly Readable.",
