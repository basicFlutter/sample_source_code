...
class SendVerificationChangePasswordUseCase extends BaseUseCase<SuccessResponse , NoParams>{
  VerificationRepository verificationRepository;
  SendVerificationChangePasswordUseCase({required this.verificationRepository});
