...
class _VehicleItemState extends State<VehicleItem> {
  ...
  Widget _card(BuildContext context) {
    return Padding(
        ...
        child: GestureDetector(
          ...
          child: Container(
            width:isSelectMode??false  ?318.w : MediaQuery.of(context).size.width,
            height: 136.h,
  ...
  Widget _moreInformation(BuildContext context) {
    return Container(
            ...
            child: Row(
              ...
              children: [
                _moreInfoItem(context:context , icon: Icons.credit_score , title:'Total Cost:', value:  AppUtils.dollarFormat(
                    widget.currentInventory.totalCost.toString()) ),
                SizedBox(
                    height: 20.h,
                    width: 10.w,
                    child: VerticalDivider(color: Theme.of(context).colorScheme.surface.withOpacity(0.5),thickness: 0.5,)) ,
                _moreInfoItem(context: context, icon: Icons.format_color_fill, title: 'Color:', value: widget.currentInventory.vehicles?.colorsVehiclesFrkExteriorColorToColors !=null ?widget.currentInventory.vehicles?.colorsVehiclesFrkExteriorColorToColors['name'] :'-'),
  ...
  Widget _moreInfoItem({required BuildContext context , required IconData icon , required String title , required String value} ) {
    return Row(
                  children: [
                    Icon(icon , size: 15.r, color: Theme.of(context).colorScheme.primary,),
                    Text(
                      title,
        ...
        children: [
          Padding(
            ...
            child: Column(
              ...
              children: [
                SizedBox(
                  width:isSelectMode??false ?118.w : MediaQuery.of(context).size.width / 3 + 20.w,
                  height: 22.h,
                  child: Text(
